...
const ChatInterface: React.FC<ChatInterfaceProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-gradient-to-b from-inventu-darker to-inventu-dark">
      {!hideModelSelector && (
        <div className="flex items-center justify-between p-3 border-b border-white/5 backdrop-blur-xl bg-black/20">
      ...
      <ScrollArea className="flex-1 px-4 py-6">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center text-white/60 mx-0 my-[55px]">
