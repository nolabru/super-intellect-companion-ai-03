...
export const defaultLumaParams: LumaParams = {
  ...
  resolution: '720p',
  duration: '5s',
  // Fixed to 5s to match API requirements
  style: 'photographic',
  aspectRatio: '16:9'
};
        ...
        <div className="space-y-4">
          ...
          {mode === 'video' && <>
              <div className="space-y-2">
                ...
                <RadioGroup value={params.videoType} onValueChange={value => handleParamChange('videoType', value)} className="flex flex-col space-y-1">
              ...
              <div className="space-y-2">
                <Label>Modelo</Label>
                <Select value={params.model} onValueChange={value => handleParamChange('model', value)}>
              ...
              <div className="space-y-2">
                <Label>Duração</Label>
                <Select value={params.duration} onValueChange={value => handleParamChange('duration', value as '3s' | '5s' | '8s' | '10s')}>
                  <SelectTrigger className="w-full bg-inventu-darker border-inventu-gray/30">
          ...
          {mode === 'image' && <>
              ...
              <div className="space-y-2">
                <Label>Estilo</Label>
                <Select value={params.style} onValueChange={value => handleParamChange('style', value)}>
                  <SelectTrigger className="w-full bg-inventu-darker border-inventu-gray/30">
              ...
              <div className="space-y-2">
                ...
                <Select value={params.aspectRatio} onValueChange={value => handleParamChange('aspectRatio', value)}>
                  <SelectTrigger className="w-full bg-inventu-darker border-inventu-gray/30">
