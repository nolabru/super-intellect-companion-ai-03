    ...
    <>
      <Card className="overflow-hidden bg-inventu-card border-inventu-gray/30 hover:border-inventu-gray/50 transition-colors mx-0 my-0 py-0 px-0">
        ...
        <CardFooter className="p-4 pt-0 flex justify-between py-[8px] mx-0 my-0 px-[18px]">
          <Button 
            ...
            className="text-red-400 hover:text-red-300 text-left bg-transparent"
          >
        ...
        <DialogContent className="max-w-4xl bg-inventu-card border-inventu-gray/30">
          ...
          <div className="flex justify-between">
            ...
            <Button 
              ...
              onClick={() => window.open(item.media_url || item.url, '_blank')}
            >
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent className="bg-inventu-card border-inventu-gray/30">
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="bg-transparent border-inventu-gray/30 text-white hover:bg-inventu-darker/50 hover:text-white">
              Cancelar
            </AlertDialogCancel>
            <AlertDialogAction 
